...
const productos = [
    ...
    { 
        ...
        colores: [
            ...
            { c: 'Blanco', hex: '#ffffff', s: 5, imgCambio: '../img/falda-volante blanca.png' }, 
            { c: 'Negro', hex: '#000000', s: 8, imgCambio: '../img/falda-volante negra.png' },
            { c: 'Celeste', hex: '#63EEFD', s: 8, imgCambio: '../img/falda-volante celeste.png' }
        ]
    },
    // 2. Top Halter
    { 
        ...
        colores: [
            ...
            { c: 'Durazno Celeste', hex: '#F7A86C', s: 0, imgCambio: '../img/top-halter-durazno.png'}, 
            { c: 'Verde Musgo', hex: '#4A6F55', s: 4 , imgCambio: '../img/top-halter verde.png'},
            { c: 'Azul', hex: '#2A5EBE', s: 3 , imgCambio: '../img/top-halter-azul.png'}
    ...
    { 
        ...
        colores: [
            ...
            {c:'Coral', hex:'#ff7f50', s: 5 , imgCambio: '../img/short-encaje coral.png'},
            {c:'Celeste', hex:'#63EEFD', s: 5 , imgCambio: '../img/short-encaje-celeste.png'},
            {c:'Blanco', hex:'#ffffffff', s: 5 , imgCambio: '../img/short-encaje blanco.png'},
            {c:'Rosa Pastel', hex:'#FFE6F8', s: 5 , imgCambio: '../img/short - encaje rosa pastel.png'},
            {c:'Rosado Quemado', hex:'#C36A72', s: 5 , imgCambio: '../img/short-encaje rosado oscuro.png'}
        ] 
    },
    // 6. Enterito Casual
    ...
    { id: 44, nombre: "Top Básico", precio: 9990, img: "../img/image-not-found.png", tallas: [{t:'S', s:5}], colores: [{c:'Blanco', hex:'#fff', s:5}] } 
];
